...
%                    polynomials (i.e., f(x)/g(x)) over a compact basic 
%                    semialgebraic set K, formulated as a moment program.
%
%  Problem: Measure program formulation:
%           minimize <f, mu> 
%           subject to mu is a measure on K and <mu, g> = 1 with 
%               f(x) = x^2-x
%               g(x) = x^2+2x+1
%               K = {x | -(x-2)*(x-4) >= 0}
%                      
