...
g_meas = [primalize(mu.support(g(1)));
          primalize(mu.support(g(2)));
          primalize(mu.support(g(3)));
          primalize(mu.support(g(4)));
          primalize(mu.support(g(5)));
          primalize(mu.support(g(6)))];   
