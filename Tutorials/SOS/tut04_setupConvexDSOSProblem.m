...
x_dsos  = s;   % dsos decision variables
x_sdsos = [];  % sdsos decision variables

% setup constraints
g_lin   = [];                % linear constraints
g_sos   = [];                % sos constraints
g_dsos  = s*(V-1)-Vdot - l;  % dsos constraints
g_sdsos = [];                % sdsos constraints
