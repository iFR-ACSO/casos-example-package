...
%           
%           a(x) = -(x1^2+x2^2+x3^2)^3+3*(x1^2+x2^2+x3^2)^2-9*(x1^2+x2^2+3)+
%                  +16*(x1^3-3*x1*x2^2+2*x3^2),
%           b(x) = 0.1-x1^2-x2^2-4*x3^2.         
%
%  Reference
...
a = -(x(1)^2+x(2)^2+x(3)^2)^3+3*(x(1)^2+x(2)^2+x(3)^2)^2-9*(x(1)^2+x(2)^2+3)+16*(x(1)^3-3*x(1)*x(2)^2+2*x(3)^2);
% b(x) >= 0 defines the set B
b = 0.1-x(1)^2-x(2)^2-4*x(3)^2;
