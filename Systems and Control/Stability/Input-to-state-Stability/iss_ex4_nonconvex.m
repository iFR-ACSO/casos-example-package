...
%                     -state (ISS) control Lyapunov function (CLF). The 
%                     example is based on the method from [1]. A simple 
%                     satellite model using quaternions is used to find a 
%                     valid ISS Lyapunov function and a control law.
%
%  Date:    15.12.2025
%
%  Reference:
...
x_lin   = [V;K ;a_bar; a_lbar; a; sigma;sh]; % linear decision variables
